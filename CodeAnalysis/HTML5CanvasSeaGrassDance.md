# HTML5CanvasSeaGrassDance

> [html5 canvas海草舞动画特效](http://www.17sucai.com/pins/demo-show?id=30497)

这个Html2 画布特效我很喜欢，尤其喜欢海草的渐变色彩，里面有关色彩的计算值得研究与学习
...
body{
  ...
  display:flex;
  align-items:center;
  justify-content:center;background-color: #232323;
}
